...
const Footer = () => {
  return (
    // <footer className="footer footer-center p-8 bg-neutral mt-20 text-primary-content">
    //   <div>
    ...
    //     <p>Paris Exchange © 2023 - Tous droits réservés </p>
    //   </div>
    //   <div>
    ...
    <footer className="footer p-10 mt-10 bg-neutral text-neutral-content">
      ...
      <div>
        <span className="footer-title">Cours et Achat/Vente</span>
        <a className="link link-hover">Akaka</a>
        <a className="link link-hover">Akaka</a>
        <a className="link link-hover">Akaka</a>
        <a className="link link-hover">Akaka</a>
      </div>
