  ...
  return (
    <div className="">
      <div className="form-control w-full max-w-xs">
        <label>
          <p className="text-xs lg:text-lg font-semibold pl-1 animate-pulse-blackred mt-4 mb-2 whitespace-nowrap">
            Choisissez le pays de votre destination:
          </p>
        </label>
        <select
          className="select select-bordered lg:select-md select-sm min-w-full"
