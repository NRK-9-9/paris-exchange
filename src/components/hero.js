...
const Hero = () => {
  return (
    ...
    <div className="hero min-h-[43vh] bg- bg-[url('https://static.vecteezy.com/system/resources/previews/002/151/433/large_2x/global-currency-exchange-network-and-technology-on-blue-background-vector.jpg')]">
