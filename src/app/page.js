    ...
    <div>
      ...
      <div className="lg:mt-10 mt-5 lg:grid lg:grid-cols-4 lg:gap-10 lg:mx-10">
        ...
        <div className="card lg:w-full lg:h-full bg-base-300 p-3 lg:mt-0 mt-14">
          ...
          Inside, we both know what's been going on (going on) We know the game
          and we're gonna play it I just wanna tell you how I'm feeling Gotta
          make you understand Never gonna give you up Never gonna let you down
