  ...
  return (
    <div className="lg:m-16 mx-5 mt-8">
      ...
      <h5 className="lg:text-xl text-md  text-gray-500">
        Notre bureau de change est situé aux 4 boulevard saint michel A gauche
        de la fontaine de saint michel Meilleurs prix de change garanties
      </h5>
      <div className="pt-12 ml-5 lg:mt-0 lg:ml-0 flex lg:flex-row flex-col-reverse lg:gap-20 gap-7 ">
        <div className="col-span-2 ">
          <iframe
            ...
            allowfullscreen=""
            className="h-[30vh] bg-base-300 lg:h-[70vh] lg:w-[44vw] rounded-md"
            loading="lazy"
          ></iframe>
        </div>
        <div>
