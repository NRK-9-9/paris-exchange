      ...
      <div>
        <h5 className="lg:text-lg text-md  text-neutral text-opacity-90 ">
          <p className="mt-2 first-letter:ml-4 first-letter:text-xl">
            À PARIS EXCHANGE, nous nous engageons fermement à respecter les lois
            et règlements en vigueur en France afin de garantir la sécurité de
            nos clients et de lutter contre le blanchiment d&apos;argent et le
            financement du terrorisme. Conformément à la législation française,
            il nous incombe de procéder à la vérification de l&apos;identité de
            nos clients lorsqu&apos;ils effectuent des transactions d&apos;achat
            de devises ou d&apos;or.
          </p>
          <p className="mt-2 first-letter:ml-4 first-letter:text-xl">
            En qualité d&apos;entreprise évoluant dans le secteur des devises et
            des métaux précieux, nous sommes assujettis à la réglementation
            française en matière de lutte contre le blanchiment d&apos;argent et
            le financement du terrorisme. Ceci implique la mise en place de
            procédures de vérification d&apos;identité pour nos clients, avec
            conservation de registres de ces vérifications.
          </p>
        </h5>
        <p className="my-2 font-bold first-letter:ml-4 first-letter:text-xl">
        ...
        <ul className="list-disc ml-4 list-outside list-image-tower ">
          <li className="ml-4 text-lg "> Carte nationale d&apos;identité </li>
          <li className="ml-4 text-lg "> Passeport </li>
          <li className="ml-4 text-lg "> Titre de séjour</li>
        </ul>
        <p className="font-bold">
          ...
          votre possession (ou une copie numérique avec le recto et le verso du
          document si présent).
        </p>
        <h1 className=" font-extrabold lg:text-3xl tracking-wider text-2xl lg:mb-5 mb-4  font-logoFont mt-10">
        ...
        <p className="first-letter:text-xl">
          ...
          modifiant les seuils de l&apos;opération change manuel au premier euro
          dès que le client n&apos;est pas présent physiquement
        </p>
      </div>
    </div>
  );
